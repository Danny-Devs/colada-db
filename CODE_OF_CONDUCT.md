...
reported to the maintainer, [@Danny-Devs](https://github.com/Danny-Devs), through
GitHub — either by a direct message or via the repository's
[Security tab](https://github.com/Danny-Devs/colada-db/security/advisories/new),
which provides a private channel. All complaints will be reviewed and
